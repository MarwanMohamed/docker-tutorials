...
$title       = __( 'Dashboard In Docker' );
$parent_file = 'index.php';

$help = '<p>' . __( 'Welcome to your WordPress Dashboard in Docker! This is the screen you will see when you log in to your site, and gives you access to all the site management features of WordPress. You can get help for any screen by clicking the Help tab above the screen title.' ) . '</p>';
